...
public class ClimateMonitor {
    ...
    public static void main (String[]args)
    {
        ...
        ClimateMonitoring.SistemaSelezione sisSelezione = new ClimateMonitoring.SistemaSelezione();
        ClimateMonitoring.SistemaRegistrazione regis = new ClimateMonitoring.SistemaRegistrazione();
        ClimateMonitoring.SistemaAccesso sisAcc = new ClimateMonitoring.SistemaAccesso();
        ClimateMonitoring.SistemaInserimento sisIns= new ClimateMonitoring.SistemaInserimento();
        ...
        while(esecuzione){
            ...
            switch (answer) {
                ...
                case 1:  // cerca e visualizza i dati raccolti
                    ClimateMonitoring.SistemaRicerca sRicerca = new ClimateMonitoring.SistemaRicerca();
